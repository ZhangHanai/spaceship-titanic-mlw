...
## Optional: reproduce lean CatBoost experiment

The lean CatBoost experiment is stored under `analysis/catboost_lean_experiment/`. It is not a replacement for `src/train_catboost.py`. It supports final analysis by providing the best clean CatBoost comparison point. Our submitted lean per-Side version achieved public score **0.80851**. The main presentation figure is still generated by:
